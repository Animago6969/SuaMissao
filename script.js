const caixaPrincipal     = documet.querySelector(".caixa-principal");   
const caixaPerguntas     = documet.querySelector(".caixa-perguntas"); 
const caixaAlternativas  = documet.querySelector(".caixa-alternativas");
const caixaResultado     = documet.querySelector(".caixa-resultado");
const texto              = documet.querySelector(".texto-resultado");
